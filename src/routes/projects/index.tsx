...
import { mybrightmaids, ligash } from '~/utils/blur';
...
const description =
  "Check out my collection of cutting-edge and top-performing software solutions. Feel motivated by my past projects.";
