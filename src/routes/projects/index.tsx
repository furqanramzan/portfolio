          ...
          >
            <div class="w-full cursor-pointer xl:w-[calc(100%-10%)]">
              <a target="_blank" href={link} class="cursor-pointer">
                <Image name={name} slug={slug} blurImage={blurImage} />
              </a>
            </div>
            <a
              target="_blank"
